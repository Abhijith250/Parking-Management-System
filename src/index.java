...
public class index extends javax.swing.JFrame {
    ...
    private void table_update(){
       ...
       String path="C:\\Users\\Abhi\\OneDrive\\Desktop\\FS\\ParkingSystem\\data.txt";
        ...
        try { 
           ...
           for (Object tableline : tablelines) {
               ...
               if(line.equals(" ")){
                ...
                catch(NumberFormatException e){System.out.println("Exixting update");
                String res=bpt.search(Integer.parseInt(data[7]));
                if(res.equals(data[7])){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Employee Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14), new java.awt.Color(255, 153, 153)));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Slot Info", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14), new java.awt.Color(255, 153, 153)));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(reportExport, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(45, 45, 45)
    ...
    private void parkButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_parkButActionPerformed
        ...
        try{
            ...
            System.out.println(e);
            System.out.println("Why this Fuck");   
        }
    ...
    private void reportExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reportExportActionPerformed
        ...
        try {    
            PdfWriter.getInstance(Doc, new FileOutputStream(DirPath+"/report1.pdf"));
            Doc.open();
            float[] relativeWidths = {100,130,100,130,80,150,150,80};
            PdfPTable TableA = new PdfPTable(8);
            TableA.setTotalWidth(relativeWidths);
            //Headers
            TableA.addCell("RC Number");
            TableA.addCell("Name");
